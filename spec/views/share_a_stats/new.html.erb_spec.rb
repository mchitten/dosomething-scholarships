...
describe "share_a_stats/new" do
  before(:each) do
    assign(:share_a_stat, stub_model(ShareAStat,
      :title => "MyString",
      :message => "MyText",
      :image => "MyString",
      :scholarship => false,
  ...
  it "renders new share_a_stat form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", share_a_stats_path, "post" do
